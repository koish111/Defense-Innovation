...
public final class SwordGuardArmPose {
    public static final EnumProxy<HumanoidModel.ArmPose> SWORD_BLOCK = new EnumProxy<>(
            HumanoidModel.ArmPose.class, false, false, (IArmPoseTransformer) SwordGuardArmPose::apply);

    private static void apply(HumanoidModel<?> model, HumanoidRenderState entity, HumanoidArm arm) {
