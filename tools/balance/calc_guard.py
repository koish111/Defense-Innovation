...
gbs = [
    ...
    ("合金大盾+PG", 0.875),
    ("双剑+PG", 1.0 - (1.0 - 0.20) ** 2),
    ("剑+原版盾+PG", 1.0 - (1.0 - 0.20) * (1.0 - 0.40)),
    ("双原版盾+PG", 1.0 - (1.0 - 0.40) ** 2),
    ("双合金大盾+PG", min(0.95, 1.0 - (1.0 - 0.875) ** 2)),
]
dmgs = [3, 5, 7, 10, 15, 20]
...
print()
print("=== D. 强力防御净体力收支（恢复暂停，单手/双手均扣一次持续消耗）===")
print(f"  默认净速率 = 0.0 - ({MAX} × 1% + 1.0) = {-MAX * 0.01 - 1.0:.1f} 点/秒")
print()
